...
-- DropForeignKey
ALTER TABLE `user` DROP FOREIGN KEY `user_room_no_fkey`;
...
-- AddForeignKey
ALTER TABLE `users` ADD CONSTRAINT `users_room_no_fkey` FOREIGN KEY (`room_no`) REFERENCES `rooms`(`room_no`) ON DELETE RESTRICT ON UPDATE CASCADE;
